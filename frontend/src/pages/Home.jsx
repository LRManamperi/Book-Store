...
import { MdOutlineDelete, MdOutlineBox } from 'react-icons/md';
        ...
        <div className='p-4'>
            <div className='flex justify-between items-center'>
                ...
                <Link to='/books/create'>
                    <MdOutlineBox className='text-sky-800 text-4xl' />
                </Link>
            </div>
            {loading ? (
                <Spinner />
                                ...
                                <td className='border border-slate-700 rounded-md text-center'>
                                    <div className='flex justify-center items-center'>
                                        <Link to={`/books/details/${book._id}`}>
                                            <BsInfoCircle className='text--800 text-2xl' />
                                        </Link>
                                        <Link to={`/book/edit/${book._id}`}>
                                            <AiOutlineEdit className='text-sky-600 text-2xl' />
                                        </Link>
